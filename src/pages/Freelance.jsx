...
const Freelance = () => {
  return (
    <div className="bg-gray-50 py-10 px-4 pb-40">
      ...
      <div className="max-w-7xl mx-auto mt-12">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900">Our Freelancers</h2>
            <p className="text-gray-500">Find our best Free Lancers here</p>
          </div>
